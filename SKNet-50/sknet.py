...
class SKNet(nn.Module):
    ...
    参考 论文Table.1 进行构造
    '''
    def __init__(self,nums_class=5,block=SKBlock,nums_block_list=[3, 4, 6, 3]):
        ...
        self.fc=nn.Linear(1024*block.expansion,nums_class) # 通道 2048 -> 5
